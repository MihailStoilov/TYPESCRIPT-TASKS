...
const btnClearLocalStorage = document.querySelector(
  "#clear-local-storage"
...
const storageTableText = document.createElement("p") as HTMLParagraphElement;
const storageTable = document.createElement("table") as HTMLTableElement;
...
function createLocalStorage(newObj: InputData) {
  ...
  robotOptionsTd.textContent = `${newObj.jump} ${newObj.blink}`;
